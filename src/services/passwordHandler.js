...
var Password = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        buf = (_a.sent());
                        // console.log("hashPassword", `${buf.toString("hex")}.${salt}`);
    ...
    Password.compare = function (storedPassword, suppliedPassword) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, hashPassword, salt, buf;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = storedPassword.split("."), hashPassword = _a[0], salt = _a[1];
                        return [4 /*yield*/, scryptAsync(suppliedPassword, salt, 64)];
                    case 1:
                        buf = (_b.sent());
                        return [2 /*return*/, buf.toString("hex") === hashPassword];
                }
            });
        });
    };
